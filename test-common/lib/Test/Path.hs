...
-- | Name of the @(Int, Int)@ test entry point generated by 'Test.Source.testModuleSource' for a leaf/test module,
-- e.g. @"test_1_0"@. Used by @compare-eviction@ to invoke a leaf's TH-splicing test module directly via the
-- worker's eval mode.
