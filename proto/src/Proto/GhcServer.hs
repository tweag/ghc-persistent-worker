...
module Proto.GhcServer (
        GhcServer(..), Empty(), Encoded(), ExecuteCommand(),
...
{- | Fields :
         ...
         * 'Proto.GhcServer_Fields.payload' @:: Lens' Encoded Data.ByteString.ByteString@ -}
data Encoded
...
instance Data.ProtoLens.Message Encoded where
  messageName _ = Data.Text.pack "ghcserver.Encoded"
  packedMessageDescriptor _
    = "\n\
      \\aEncoded\DC2\CAN\n\
...
instance Data.ProtoLens.Service.Types.Service GhcServer where
  ...
  packedServiceDescriptor _
    = "\n\
      \\tGhcServer\DC2B\n\
      \\aExecute\DC2\EM.ghcserver.ExecuteCommand\SUB\SUB.ghcserver.ExecuteResponse\"\NUL\DC22\n\
      \\ACKEvents\DC2\DLE.ghcserver.Empty\SUB\DC2.ghcserver.Encoded\"\NUL0\SOH\DC2/\n\
      \\ETXApi\DC2\DC2.ghcserver.Encoded\SUB\DC2.ghcserver.Encoded\"\NUL"
...
instance Data.ProtoLens.Service.Types.HasMethodImpl GhcServer "events" where
  ...
  type MethodOutput GhcServer "events" = Encoded
...
instance Data.ProtoLens.Service.Types.HasMethodImpl GhcServer "api" where
  ...
  type MethodInput GhcServer "api" = Encoded
  type MethodOutput GhcServer "api" = Encoded
...
packedFileDescriptor
  = "\n\
    ...
    \\ENQEmpty\"#\n\
    \\aEncoded\DC2\CAN\n\
    \\apayload\CAN\SOH \SOH(\fR\apayload2\180\SOH\n\
    \\tGhcServer\DC2B\n\
    \\aExecute\DC2\EM.ghcserver.ExecuteCommand\SUB\SUB.ghcserver.ExecuteResponse\"\NUL\DC22\n\
    \\ACKEvents\DC2\DLE.ghcserver.Empty\SUB\DC2.ghcserver.Encoded\"\NUL0\SOH\DC2/\n\
    \\ETXApi\DC2\DC2.ghcserver.Encoded\SUB\DC2.ghcserver.Encoded\"\NULJ\143\ACK\n\
    ...
    \\n\
    \\n\
    \\ETX\EOT\ETX\SOH\DC2\ETX\NAK\b\SI\n\
    \\v\n\
    ...
    \\DC1\n\
    \\f\n\
    \\ENQ\ACK\NUL\STX\STX\ETX\DC2\ETX\FS\FS#b\ACKproto3"